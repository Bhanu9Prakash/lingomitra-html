...
| Number | Hindi | Transliteration | Pronunciation Hint |
|--------|-------|----------------|-------------------|
...
The tens follow a more recognizable pattern:
...
Hindi uses a different numbering system for larger values:
...
> **Thinking Point:** Notice how all possessives end with `-e` before `पास`. This is because `पास` requires the oblique case, which we'll learn more about later.
...
## Lesson 13: Adding Detail - Adverbs & Adverbial Phrases
...
## Lesson 14: Giving Commands & Instructions - The Imperative Mood
...
**Note:** Adding `कृपया` (kripaya - please) makes the command even more polite.
...
* **Formality Mismatch:** Using an inappropriate imperative form for the social context (e.g., using तू form with strangers or elders).
...
## Lesson 15: Advanced Tenses - The Continuous Present and Past
...
* `मैं खाना नहीं खा रहा हूँ।` - `Main khana nahin kha raha hoon.` (I am not eating food.)
...
### The Future Continuous Tense (भविष्यकालिक कालिक क्रिया - Bhavishyakaalik Kaalik Kriya)
...
## Lesson 16: Describing People & Things - Adjectives in Hindi
...
### Examples of Unchangeable Adjectives
...
**Unchangeable adjectives remain the same even in the oblique case:**
...
## Lesson 17: Personal Pronouns in Cases
...
## Lesson 18: Saying "No" and "Not" - Negation in Hindi
...
> **Thinking Point:** Note that `मत` (mat) is used only for commands - it tells someone not to do something. For statements (describing what is not happening), use `नहीं` (nahin).
...
* Question: `क्या तुम जा रहे हो?` - `Kya tum ja rahe ho?` (Are you going?)
...
1. `मैं हिंदी नहीं बोलता हूँ।` - `Main Hindi nahin bolta hoon.`
...
## Lesson 19: Connecting Clauses - Relative Pronouns & Relative Clauses
...
## Lesson 20: Conditional Sentences - If-Then Statements

Conditional sentences express hypothetical situations and their potential results. They're used to talk about what might happen, what would happen, or what would have happened under specific conditions. In this lesson, we'll explore how Hindi forms different types of conditional sentences.

### Structure of Conditionals in Hindi

Hindi conditional sentences typically use specific pairs of words to establish the if-then relationship, the most common being:

1. **अगर...तो (agar...to)** - if...then
2. **यदि...तो (yadi...to)** - if...then (more formal)

The basic structure is:
**अगर/यदि [condition clause], तो [result clause].**

Let's explore the different types of conditional sentences:

### 1. Real Conditionals (Factual/Present)

These express real or likely situations and their probable results.

**Structure:**
* Condition Clause: Present Tense
* Result Clause: Present/Future Tense

**Examples:**
* `अगर बारिश होती है, तो मैं घर पर रहता हूँ।` - `Agar baarish hoti hai, to main ghar par rahta hoon.` (If it rains, I stay at home.) - male speaker
* `यदि आप मेहनत करते हैं, तो आप सफल होते हैं।` - `Yadi aap mehnat karte hain, to aap safal hote hain.` (If you work hard, you succeed.) - to male
* `अगर तुम समय पर आओगे, तो हम फिल्म देखेंगे।` - `Agar tum samay par aaoge, to hum film dekhenge.` (If you come on time, we will watch a movie.) - to male

### 2. Unreal Conditionals (Hypothetical/Present)

These express unlikely or hypothetical situations and their potential results.

**Structure:**
* Condition Clause: Subjunctive (verb stem + ता/ती/ते + Past auxiliary)
* Result Clause: Subjunctive (verb stem + ता/ती/ते + Past auxiliary)

**Examples:**
* `अगर मेरे पास पैसे होते, तो मैं एक नई कार खरीदता।` - `Agar mere paas paise hote, to main ek nayi car kharidta.` (If I had money, I would buy a new car.) - male speaker
* `यदि वह यहाँ होती, तो वह मदद करती।` - `Yadi voh yahan hoti, to voh madad karti.` (If she were here, she would help.)
* `अगर मैं अमीर होता, तो दुनिया घूमता।` - `Agar main ameer hota, to duniya ghoomta.` (If I were rich, I would travel the world.) - male speaker

### 3. Past Unreal Conditionals (Counterfactual/Past)

These express situations that didn't happen in the past and their hypothetical results.

**Structure:**
* Condition Clause: Past Subjunctive (Perfect Tense + होता/होती/होते)
* Result Clause: Past Subjunctive (Perfect Tense + होता/होती/होते)

**Examples:**
* `अगर मैंने परीक्षा पास की होती, तो मैं खुश होता।` - `Agar maine pariksha pass ki hoti, to main khush hota.` (If I had passed the exam, I would have been happy.) - male speaker
* `यदि बारिश नहीं हुई होती, तो हम पिकनिक पर जाते।` - `Yadi baarish nahin hui hoti, to hum picnic par jate.` (If it hadn't rained, we would have gone on a picnic.)
* `अगर वह ट्रेन पकड़ लिया होता, तो वह समय पर पहुँच जाता।` - `Agar voh train pakar liya hota, to voh samay par pahunch jata.` (If he had caught the train, he would have reached on time.)

### Common Conditional Expressions

#### 1. Special Expression: होता तो / होती तो (hota to / hoti to) - If it were so

* `होता तो मैं ज़रूर आता।` - `Hota to main zaroor aata.` (If it were possible, I would definitely come.)
* `होती तो क्या बात थी!` - `Hoti to kya baat thi!` (If it had happened, it would have been wonderful!)

#### 2. Mixed Conditionals

Sometimes the condition and result may refer to different time frames:

* `अगर मैंने पढ़ाई अच्छे से की होती, तो आज मैं अच्छी नौकरी करता।` - `Agar maine parhai achche se ki hoti, to aaj main achchi naukri karta.` (If I had studied well [past], I would have a good job today [present].) - male speaker

#### 3. Other Conditional Expressions

* `चाहे...लेकिन` (chahe...lekin) - even if...but
  * `चाहे कितनी भी बारिश हो, लेकिन मैं आऊँगा।` - `Chahe kitni bhi baarish ho, lekin main aaoonga.` (Even if it rains heavily, I will come.) - male speaker

* `जब तक...तब तक` (jab tak...tab tak) - until/unless
  * `जब तक तुम नहीं आओगे, तब तक मैं इंतज़ार करूँगा।` - `Jab tak tum nahin aaoge, tab tak main intezaar karoonga.` (Until you come, I will wait.) - male speaker

### Variations and Shortcuts in Conditional Sentences

#### 1. Omitting तो (to)

In casual speech, `तो` (to) is sometimes omitted:

* Complete: `अगर तुम आओगे, तो मैं भी आऊँगा।` - `Agar tum aaoge, to main bhi aaoonga.`
* Shortened: `अगर तुम आओगे, मैं भी आऊँगा।` - `Agar tum aaoge, main bhi aaoonga.` (If you come, I will also come.) - male speaker

#### 2. Swapping Clause Order

The result clause can come before the condition clause:

* Standard: `अगर बारिश होगी, तो मैं नहीं आऊँगा।` - `Agar baarish hogi, to main nahin aaoonga.`
* Swapped: `मैं नहीं आऊँगा, अगर बारिश होगी।` - `Main nahin aaoonga, agar baarish hogi.` (I won't come if it rains.) - male speaker

#### 3. Using तब (tab) instead of तो (to)

Sometimes `तब` (tab - then) is used instead of `तो` (to):

* `अगर तुम मेहनत करोगे, तब तुम्हें सफलता मिलेगी।` - `Agar tum mehnat karoge, tab tumhein safalta milegi.` (If you work hard, then you will get success.) - to male

### Common Mistakes

* **Mixing Tenses:** Using incorrect tense combinations for the type of conditional (e.g., using simple past instead of subjunctive in hypothetical conditionals).
* **Missing होता/होती/होते in Unreal Conditionals:** Forgetting the subjunctive marker in hypothetical conditions.
* **Wrong Word Order:** Not maintaining the proper word order within the condition and result clauses.
* **Omitting the Correlative:** In formal contexts, omitting `तो` (to) can be considered incomplete.
* **Gender Agreement Issues:** Not ensuring proper gender agreement in subjunctive forms.

### Quick Practice

Translate these conditional sentences into Hindi, focusing on the correct structure for each type.

1. If you come tomorrow, we will go to the market. (to male friend)
2. If I had money, I would buy a new phone. (male speaker)
3. If she had studied harder, she would have passed the exam.
4. If it rains, the match will be cancelled.
5. If you were in my place, what would you do? (to female friend)
6. Even if he comes, I won't talk to him.
7. If I get the job, I'll be very happy. (female speaker)

*(Pay attention to the type of conditional and use the appropriate tense structure!)*

---
***Practice Answers:***

1. `अगर तुम कल आओगे, तो हम बाज़ार जाएँगे।` - `Agar tum kal aaoge, to hum bazaar jayenge.`
2. `अगर मेरे पास पैसे होते, तो मैं एक नया फोन खरीदता।` - `Agar mere paas paise hote, to main ek naya phone kharidta.`
3. `अगर उसने ज़्यादा मेहनत की होती, तो वह परीक्षा पास कर लेती।` - `Agar usne zyada mehnat ki hoti, to voh pariksha pass kar leti.`
4. `अगर बारिश होगी, तो मैच रद्द हो जाएगा।` - `Agar baarish hogi, to match radd ho jayega.`
5. `अगर तुम मेरी जगह होतीं, तो क्या करतीं?` - `Agar tum meri jagah hotin, to kya kartin?`
6. `चाहे वह आए, लेकिन मैं उससे बात नहीं करूँगा।` - `Chahe voh aaye, lekin main usse baat nahin karoonga.` (male speaker) / `चाहे वह आए, लेकिन मैं उससे बात नहीं करूँगी।` - `Chahe voh aaye, lekin main usse baat nahin karoongi.` (female speaker)
7. `अगर मुझे नौकरी मिलेगी, तो मैं बहुत खुश होऊँगी।` - `Agar mujhe naukri milegi, to main bahut khush hoongi.`

---

## Lesson 21: Making Polite Requests - Please and Thank You
...
## Lesson 22: Word Building - Common Prefixes and Suffixes
...
Adding a modified version of a word to create a pair:
...
## Lesson 23: Using Compound Verbs for Natural Expression
...
**Example with `कर लेना` (kar lena - to do for oneself):**
...
* `सोचता रहना` (sochta rahna) - to keep thinking
...
## Lesson 24: Common Expressions & Daily Phrases
...
### Useful Exclamations and Fillers
...
## Lesson 25: Consolidating Your Hindi Knowledge - Review and Practice
